...
namespace EmuLibDebugger
{
    public class Cons
    {
        ...
        public class Status {
                ...
                private static string GetHealthEndStatus(EBodyPart Part) {
                ...
                public static void UpdateStatus()
                {
                    ...
                    Health.Chest = GetHealthEndStatus(EBodyPart.Chest);
                    Health.Common = GetHealthEndStatus(EBodyPart.Common);
                    Health.Head = GetHealthEndStatus(EBodyPart.Head);
                    Health.LeftArm = GetHealthEndStatus(EBodyPart.LeftArm);
                    Health.LeftLeg = GetHealthEndStatus(EBodyPart.LeftLeg);
                    Health.RightArm = GetHealthEndStatus(EBodyPart.RightArm);
                    Health.RightLeg = GetHealthEndStatus(EBodyPart.RightLeg);
                    Health.Stomach = GetHealthEndStatus(EBodyPart.Stomach);
                }
            }
            #endregion
        }
        public class Main
        {
            ...
            public static Dictionary<GInterface165, GameWorld.GStruct65>.Enumerator _containers;
        ...
        public class Buttons {
            public static bool DebugBut = false;
        }
        public class Bools
        {
            ...
            public static bool Display_CordsHUD = false;
        ...
        public static string[] HelpMenuTexts = new string[11] {
