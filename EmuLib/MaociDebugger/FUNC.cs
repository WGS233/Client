    ...
    class FUNC
    {
        ...
        public class Update {
            ...
            public static void Hotkeys()
            {
                ...
                {
                    Cons.Bools.Display_CordsHUD = !Cons.Bools.Display_CordsHUD;
                }
                #endregion
                ...
                if (Cons.Bools.IKnowWhatImDoing)
                {
                    ...
                    {
                        // simple FOV changer
                        GClass440.SetFov(120f, 1f);
                        GClass440.ApplyFoV(120, 100, 120);
                    }
                }
                #endregion
                /* unused yet
